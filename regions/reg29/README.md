...
This folder is the region-default content layer for `reg29`.
...
- `regions/reg29/data/primary-assets.json`
- `regions/reg29/data/primary.json`
- `regions/reg29/data/footer.json`
- `regions/reg29/data/primaryending.json`
- `regions/reg29/assets/primary/manifest.json`
- `regions/reg29/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg29`.
